...
class {Module}Controller extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            Alert::success('Notification', 'Data <b>' . ${model}->name . '</b> saved successfully')->toToast()->toHtml();
        } catch (\Throwable $th) {
            Alert::error('Notification', 'Data <b>' . ${model}->name . '</b> failed to save : ' . $th->getMessage())->toToast()->toHtml();
        }
        return back();
    }
