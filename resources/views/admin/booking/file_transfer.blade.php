                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="booking_id" name="booking_id" value="0000{{ $booking->id }}" disabled>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" name="booking_date" class="date form-control" data-input>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="reference" name="reference" placeholder="Referance">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select class="form-control select2 " name="project_id" id="project_id" disabled>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="old_customer_id" value="{{ $booking->customer_id }}">
                                                        <select class="form-control select2" name="customer_id" id="customer_id">
                                                            <option value="">Select Customer</option>
                                                            @foreach ($customers as $v)
                                                                    <option value="{{ $v->id }}" {{ $booking->customer_id == $v->id ? 'selected' : '' }}>{{ $v->first_name . ' ' . $v->last_name .' '. $v->relate . ' '. $v->father_name . ' - ' . $v->phone_number }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('customer_id')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" name="plot_type" id="plot_type" disabled>
                                                            <option value="" {{ $booking->plot_type == '' ? 'selected' : '' }}>Select Plot type</option>
                                                            <option value="1" {{ $booking->plot_type == '1' ? 'selected' : '' }}>Residential</option>
                                                            <option value="2" {{ $booking->plot_type == '2' ? 'selected' : '' }}>Commercial</option>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" name="plot_id" id="plot_id" disabled>
                                                            ...
                                                            @foreach ($plots as $v)
                                                                    <option value="{{ $v->id }}" data-size='{{ $v->size }}' {{ $booking->plot_id == $v->id ? 'selected' : '' }}>{{ $v->name }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('plot_id')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="plot_size" name="plot_size" value="{{ $booking->plot_size }}" required placeholder="Plot Size (Marla)" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" name="broker_id" id="broker_id" disabled>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="status" value="{{ $booking->status == 'active' ? '1' : '0' }}">
                                                        <select class="form-control" id="status" name="status" required placeholder="Status" disabled>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <select class="form-control" id="is_park" name="is_park" required placeholder="Park Facing">
                                                    <option value="1" {{ $booking->is_park == '1' ? 'selected' : '' }}>Yes</option>
                                                    <option value="0" {{ $booking->is_park == '0' ? 'selected' : '' }}>No</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <select class="form-control" id="is_corner" name="is_corner" required placeholder="Corner Facing" >
                                                    <option value="1" {{ $booking->is_corner == '1' ? 'selected' : '' }}>Yes</option>
                                                    <option value="0" {{ $booking->is_corner == '0' ? 'selected' : '' }}>No</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <select class="form-control" id="party" name="party" required placeholder="Corner Facing" >
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="party_fee" name="party_fee" placeholder="Fee pay by" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="discount_value" name="discount_value" value="{{ $booking->discount_value ?? '' }}" placeholder="Discount Amount " >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="total_price" name="total_price" value="{{ $booking->total_price ?? '' }}" placeholder="Grand Total" readonly>
                                            </div>
                                        </div>
                                    </div>
