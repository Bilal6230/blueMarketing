                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="booking_id" name="booking_id"
                                                    value="{{ get_new_booking_number() }}" disabled>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="plot_size" name="plot_size"
                                                    required placeholder="Plot Size (Marla)" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <input type="text" class="form-control"
                                                    id="plot_rate" name="plot_rate" placeholder="Rate / Marla " readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="sub_total_price"
                                                    name="sub_total_price" placeholder="Total Price" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="park_facing" name="park_facing"
                                                    placeholder="Park Facing Charges " readonly>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="carner_price"
                                                    name="carner_price" placeholder="Carner Charges " readonly>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="discount_value"
                                                    name="discount_value" placeholder="Discount Amount ">
                                            </div>
                                        </div>
                                    </div>
