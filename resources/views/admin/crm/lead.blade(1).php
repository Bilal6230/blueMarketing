                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="phone_number" type="text" class="form-control @error('phone_number') is-invalid @enderror" placeholder="1st Phone Number" name="phone_number" value="{{ old('phone_number') }}" readonly>
                                        @error('phone_number')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="mobile_number" type="text" class="form-control @error('mobile_number') is-invalid @enderror" placeholder="2st Phone Number" name="mobile_number" value="{{ old('mobile_number') }}" readonly>
                                        @error('mobile_number')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
