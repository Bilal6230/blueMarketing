    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
            ...
            <select id="actionDropdown" class="form-control ">
                @foreach (getProjects() as $v)
                    <option value="{{ $v->id }}" {{ $id == $v->id ? 'selected' : '' }}>{{ $v->project }}</option>
                @endforeach
            </select>
        </li>
        @endcanany
        ...
        <li class="nav-item dropdown user-menu">
            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                <img src="/storage/{{  Auth::user()->avatar }}" class="user-image img-circle elevation-2" alt="User Image">
            ...
            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <li class="user-footer">
                    ...
                    <a href="#" data-toggle="modal" data-target="#modal-logout" data-backdrop="static" data-keyboard="false" class="btn btn-danger float-right">Sign Out</a>
                </li>
            </ul>
        </li>
    </ul>
