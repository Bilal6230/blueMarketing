            ...
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @canany(['read user', 'read role', 'read permission'])
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview" style="display: {{ request()->routeIs('accounting*') ? 'block':'none' }};">
                            @can('read user')
                                <li class="nav-item">
                                    <a href="{{ route('accounting.head_index') }}" class="nav-link {{ request()->routeIs('accounting.head_index') ? 'active':'' }}">
                            ...
                            @can('read user')
                                <li class="nav-item">
                                    <a href="{{ route('accounting.subhead_index') }}" class="nav-link {{ request()->routeIs('accounting.subhead_index') ? 'active':'' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Child Account</p>
                                    </a>
                                </li>
                            ...
                            @can('read user')
                                <li class="nav-item">
                                    <a href="{{ route('accounting.category_index') }}" class="nav-link {{ request()->routeIs('accounting.category_index') ? 'active':'' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Joint Account</p>
                                    </a>
                                </li>
                ...
                @canany(['read project', 'read sector' , 'read area'])
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview" style="display: {{ request()->routeIs('project*','area*') ? 'block':'none' }};">
                            @can('read project')
                                <li class="nav-item">
                            ...
                            @can('read sector')
                                <li class="nav-item">
                                    <a href="{{ route('project.zone.index') }}" class="nav-link {{ request()->routeIs('project.zone.index') ? 'active':'' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Sectors</p>
                                    </a>
                                </li>
                            ...
                            @can('read plot')
                                <li class="nav-item">
                                    <a href="{{ route('project.plot.index') }}" class="nav-link {{ request()->routeIs('project.plot.index') ? 'active':'' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Plots</p>
                                    </a>
                                </li>
                ...
                @canany(['read voucher', 'read slip', 'add slip','read jv'])
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview" style="display: {{ request()->routeIs('finance.voucher*') ? 'block':'none' }};">
                            ...
                            @can('read voucher')
                                <li class="nav-item">
                                    <a href="{{ route('finance.voucher.in') }}" class="nav-link {{ request()->routeIs('finance.voucher.in') ? 'active':'' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Cash In</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('finance.voucher.out') }}" class="nav-link {{ request()->routeIs('finance.voucher.out') ? 'active':'' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Cash out</p>
                                    </a>
                                </li>
                            ...
                            @can('read jv')
                            <li class="nav-item">
                                <a href="{{ route('journal.voucher.index') }}" class="nav-link {{ request()->routeIs('journal.voucher.index') ? 'active':'' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Journal Voucher</p>
                                </a>
                            </li>
                            ...
                            @canany(['read slip', 'add slip'])
                                <li class="nav-item">
                                    <a href="{{ route('payment_schedule.cash') }}" class="nav-link {{ request()->routeIs('payment_schedule.cash') ? 'active':'' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Receive Payment</p>
                                    </a>
                                </li>
                ...
                @canany(['report party_report', 'report cashbook', 'party_ledger'])
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview" style="display: {{ request()->routeIs('finance.reports*') ? 'block':'none' }};">
                            ...
                            @can('report cashbook')
                                <li class="nav-item">
                                    <a href="{{ route('finance.reports.show_ledger') }}" class="nav-link {{ request()->routeIs('finance.reports.show_ledger') ? 'active':'' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Cash Book</p>
                                    </a>
                                </li>
                            ...
                            @can('report party_report')
                                <li class="nav-item">
                                    <a href="{{ route('finance.reports.show_ledger_party') }}" class="nav-link {{ request()->routeIs('finance.reports.show_ledger_party') ? 'active':'' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Party Wise Report</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('finance.reports.show_ledger_head') }}" class="nav-link {{ request()->routeIs('finance.reports.show_ledger_head') ? 'active':'' }}">
                                        <i class="far fa-circle nav-icon"></i>
                            ...
                            @can('cheque report')
                                <li class="nav-item">
                                    <a href="{{ route('report.check') }}" class="nav-link {{ request()->routeIs('report.check') ? 'active':'' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Cheque Report</p>
                                    </a>
                                </li>
                ...
                @canany(['read lead'])
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview" style="display: {{ request()->routeIs('crm*') ? 'block':'none' }};">
                            @can('read lead')
                                <li class="nav-item">
                                    <a href="{{ route('crm.lead.index') }}" class="nav-link {{ request()->routeIs('crm.lead.index') ? 'active':'' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>All Lead</p>
                                    </a>
                                </li>
                            ...
                            @can('read lead')
                                <li class="nav-item">
                                    <a href="{{ route('lead.work') }}" class="nav-link {{ request()->routeIs('lead.work') ? 'active':'' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Start Work</p>
                                    </a>
                                </li>
                ...
                @canany(['lead report', 'read lead','cheque report'])
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview" style="display: {{ request()->routeIs('report*') ? 'block':'none' }};">
                            {{-- @can('read lead')
                                <li class="nav-item">
                ...
                @canany(['read project', 'read sector' , 'read area', 'read plot','view inventory'])
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview" style="display: {{ request()->routeIs('booking*') ? 'block':'none' }};">
                            @can('read plot')
                                <li class="nav-item">
                                    <a href="{{ route('booking.plot.index') }}" class="nav-link {{ request()->routeIs('booking.plot.index') ? 'active':'' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Plot Sale</p>
                                    </a>
                                </li>
                            ...
                            @can('read plot')
                                <li class="nav-item">
                                    <a href="{{ route('booking.plot.recovery_list') }}" class="nav-link {{ request()->routeIs('booking.plot.recovery_list') ? 'active':'' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Project Report</p>
                                    </a>
                                </li>
                            ...
                            @can('view inventory')
                                <li class="nav-item">
                                    <a href="{{ route('booking.plot.inventory') }}" class="nav-link {{ request()->routeIs('booking.plot.inventory') ? 'active':'' }}">
                                        <i class="far fa-circle nav-icon"></i>
                ...
                @canany(['read user', 'read role', 'read permission'])
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview" style="display: {{ request()->routeIs('user*') ? 'block':'none' }};">
                            @can('read user')
                                <li class="nav-item">
                ...
                @canany(['read setting', 'filemanager'])
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview" style="display: {{ request()->routeIs('setting*') ? 'block':'none' }};">
                            @can('read setting')
                                <li class="nav-item">
